...
<html lang="en">
	<head>
		...
		<title>chattypatty 3.2 - By Fred Eaker</title>
	...
	<body>
		<div class="container"> <!-- bootstrap container start -->
			...
			<div class="row">
				<div class="col">
					<h1>chattypatty 3.2</h1>
					<p>Basic vanilla HTML and JavaScript implementation of the ChatGPT API. Created by <a href='https://fredeaker.com/'>Fred Eaker</a>.</p>
				</div>
				
				<div class="col"> <!-- completion parameters section -->
					<div class="form-group">
						...
						<label for="persona-select">Select persona (optional)</label>
						<select class="form-select" aria-label="Select persona (optional)" name="persona-select" id="persona-select">
							<option value='none' selected>None</option>
							<option value='smg'>Social Media Guru</option>
			...
			<div class="row"> <!-- output section -->
				<div class="col">
					<label for="oai_api_response"><h2>Response</h2></label>
			...
			<div class="row"> <!-- debug section -->
				<div class="col">
					<h2>Debug</h2>
					<div id="debug" class="alert alert-primary" role="alert"></div>
				</div>
			</div>
